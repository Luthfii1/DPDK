...
#define NB_MBUF_UE_SIDE         (8192 * 1)
#define NB_MBUF_CU_SIDE         (8192 * 1)

/* How many packets to attempt to read from NIC in one go */
#define PKT_BURST_SZ            128
...
#define NB_RXD                  4096 * 4

/* Number of TX ring descriptors */
#define NB_TXD                  4096 * 4
...
extern rte_atomic32_t qos_flow_config_mutex;

extern uint32_t du_dl_trunk_ip, du_f1u_ip;
