...
extern int back_core;
extern int back_port_rx;
extern int back_port_tx[3];
extern struct rte_eth_dev_tx_buffer *back_tx_buffer[3];
...
uint32_t get_qavg_q(uint16_t port_id, uint32_t subport_id, uint32_t pipe_id,
	   uint8_t tc, uint8_t q);
